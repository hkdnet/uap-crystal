...
module UserAgentParser
  class Parser
    getter :patterns_path

    def initialize(@pattern_path = "")
      @patterns_path = UserAgentParser::DefaultPatternsPath if @pattern_path == ""
    ...
    private def load_patterns(path)
    ...
    private def parse_ua(user_agent, os = nil, device = nil)
    ...
    private def parse_os(user_agent)
    ...
    private def parse_device(user_agent)
    ...
    private def first_pattern_match(patterns, value)
      patterns.each do |pattern|
    ...
    private def user_agent_from_pattern_match(pattern, match, os = nil, device = nil)
    ...
    private def os_from_pattern_match(pattern, match)
    ...
    private def device_from_pattern_match(pattern, match)
    ...
    private def version_from_segments(*segments)
